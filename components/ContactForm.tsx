      ...
      >
        ...
        <div className="mt-6">
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-[var(--accent)] px-8 py-3.5 text-sm font-medium text-[var(--accent-fg)] transition-opacity hover:opacity-90 sm:w-auto"
          >
            <svg
              width="20"
              height="20"
